...
const socialLinks = [
  ...
  { icon: Mail, href: "mailto:support@applyafk.com", label: "Email" },
]
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-16 relative z-10">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 lg:gap-8">
          ...
          >
            ...
            <p className="mt-4 text-muted-foreground max-w-sm leading-relaxed">
              Your personal job application assistant working 24/7. Focus on what matters while we handle the applications.
            </p>
        ...
        >
          <p className="text-sm text-muted-foreground">
            © {new Date().getFullYear()} ApplyAFK. All rights reserved.
          </p>
          <p className="text-sm text-muted-foreground">
